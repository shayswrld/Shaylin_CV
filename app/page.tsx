    ...
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
        ...
        <ul className="flex items-center justify-center gap-4">
          {navigation.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="text-sm duration-500 text-zinc-500 hover:text-zinc-300 transition-colors"
            >
              {item.name}
            </Link>
          ))}
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-8 z-10 max-w-4xl mx-auto px-4">
        ...
        <div className="animate-fade-in animation-delay-500">
          <h2 className="text-lg sm:text-xl md:text-2xl text-zinc-300 font-light tracking-wide">
            ...
            <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent font-medium">
              ML, Data Science, Big Data & AI
            </span>
          </h2>
        </div>
      </div>

      <div className="hidden w-screen h-px animate-glow md:block animate-fade-right bg-gradient-to-r from-zinc-300/0 via-zinc-300/50 to-zinc-300/0 mt-16" />

      {/* GitHub Link */}
      <div className="my-16 text-center animate-fade-in animation-delay-1000">
        <div className="flex items-center justify-center gap-2 text-sm text-zinc-500">
          ...
          <Link
            target="_blank"
            href="https://github.com/shayswrld"
            className="underline duration-500 hover:text-zinc-300 transition-colors font-medium"
          >
            shayswrld
          </Link>
        </div>
